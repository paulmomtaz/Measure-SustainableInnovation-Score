...
os.environ[
    "CORENLP_HOME"
] = "/Users/yuruchen/CoreNLP"  # location of the CoreNLP models; use / to seperate folders
...
DIMS: List[str] = ["sustainable_innovation"]
SEED_WORDS: Dict[str, List[str]] = {
    "sustainable_innovation": [
        "carbon_footprint_reduction",
        "circular_economy_initiatives",
        "circular_economy",
        "clean_energy_breakthroughs",
        "clean_technology",
        "climate_change_mitigation",
        "climate-friendly_inventions",
        "conservation_innovation",
        "eco-friendly_advancements",
        "eco-friendly_materials",
        "eco-innovations",
        "ecological_innovation",
        "emissions_reduction",
        "energy_efficiency",
        ...
        "green_building",
        "green_technology",
        "low-carbon_innovations",
        "low-impact_manufacturing",
        "renewable_energy",
        "renewable_solutions",
        "resource-efficient_solutions",
        "sustainability",
        "sustainable_agriculture",
        "sustainable_business_practices",
        "sustainable_development",
        "sustainable_entrepreneurship",
        "sustainable_innovation",
        "sustainable_manufacturing_advancements",
